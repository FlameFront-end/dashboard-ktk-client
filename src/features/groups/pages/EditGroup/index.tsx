...
const UpdateGroup: FC = () => {
    ...
    const handleAddSubject = (day: string): void => {
        setSchedule((prev) => ({
            ...prev,
            [day]: [...prev[day], { discipline: null, teacher: null, cabinet: '' }]
        }));
    };
                      ...
                      <Flex direction="column" gap={24}>
                          {schedule[en].map((subject, index) => {
                              const availableTeachers = teachers?.filter((teacher) =>
                                subject.discipline ? teacher.disciplines.some(d => d.id === subject.discipline.id) : true
                              );
                              ...
                              return (
                                <Space key={index} align="baseline">
                                    <Select
                                      ...
                                      value={subject.discipline?.id || null}
