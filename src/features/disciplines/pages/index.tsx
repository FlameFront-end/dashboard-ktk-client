...
const Disciplines: FC = () => {
    ...
    const [editingDiscipline, setEditingDiscipline] = useState<Collections.Discipline | null>(null)
    ...
    const onFinish = (values: any): void => {
        void createDiscipline(values).then(() => {
    ...
    const renderActions = (record: DataSource): ReactNode => {
        ...
        return (
            <Space>
                ...
                <ConfirmDelete
                    handleDelete={async () => { await handleDelete(discipline.id) }}
