    ...
    const menuItems: MenuItemsWithSeparators = [
        ...
        ...(groupId
          ? [
              <Separator key="separator-1" />,
              {
                  ...
                  onClick: () => {
                      navigate(pathsConfig.group, { state: { id: groupId } })
                  },
              },
              {
                  ...
                  onClick: () => {
                      navigate(pathsConfig.group_performance, { state: { id: groupId } })
                  },
              },
              ...(role === 'student'
                ? [
                    {
                        ...
                        onClick: () => {
                            navigate(pathsConfig.individual_performance, { state: { id: userId } })
                        },
                    },
                ]
                : []),
              {
                  ...
                  onClick: () => {
                      navigate(pathsConfig.lessons, { state: { id: groupId } })
                  },
              },
          ]
          : []),
          ...
          ? [
              {
                  ...
                  onClick: () => {
                      navigate(pathsConfig.chat, { state: { id: chat.id } })
                  },
                  state: { id: chat.id },
              },
          ]
        ...
        ...(role === 'teacher' && teacher?.teachingGroups
            ? teacher.teachingGroups
              .filter((group) => group.id !== teacher.group?.id).length > 0
              ? [
                  ...
                  ...teacher.teachingGroups
                    ...
                    .map((group) => ({
                        ...
                        path: pathsConfig.chat,
                        onClick: () => {
                            navigate(pathsConfig.chat, { state: { id: group.chat.id } })
                        },
